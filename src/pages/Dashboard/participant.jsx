...
const Participant = () =>{
    ...
    // Add new  participant to the  state 
    ...
    const handleReomveParticipant = async(participantId)=>{
        try{
            ...
            setParticipants((prevParticipants)=>prevParticipants.filter((participant)=> participant._id !== data._id));
        }
        catch(error){
            throw error;
        }
    ...
    const handleUpdate = (updatedParticipant) => {
        setParticipants((prevParticipants) =>
            prevParticipants.map((participant) => (participant._id === updatedParticipant._id ? updatedParticipant : participant))
        );
